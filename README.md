...
| __yash__ | [![x86 Yash on Debian](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_x86_yash_on_debian_mode_unit.json)](https://github.com/tinmarino/inmembin/actions/workflows/x86.yml) [![arm Yash on Debian](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_arm_yash_on_debian_mode_unit.json)](https://github.com/tinmarino/inmembin/actions/workflows/arm.yml) <br/> [![x86 Yash on Debian](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_x86_yash_on_debian_mode_sync.json)](https://github.com/tinmarino/inmembin/actions/workflows/x86.yml) [![x86 Yash on Debian](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_x86_yash_on_debian_mode_async.json)](https://github.com/tinmarino/inmembin/actions/workflows/x86.yml) | [![x86 Yash on Arch](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_x86_yash_on_archlinux_mode_unit.json)](https://github.com/tinmarino/inmembin/actions/workflows/x86.yml) [![arm Yash on Arch](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_arm_yash_on_archlinux_mode_unit.json)](https://github.com/tinmarino/inmembin/actions/workflows/arm.yml) <br/> [![x86 Yash on Arch](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_x86_yash_on_archlinux_mode_sync.json)](https://github.com/tinmarino/inmembin/actions/workflows/x86.yml) [![x86 Yash on Arch](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_x86_yash_on_archlinux_mode_async.json)](https://github.com/tinmarino/inmembin/actions/workflows/x86.yml) | [![x86 Yash on Alpine](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_x86_yash_on_alpine_mode_unit.json)](https://github.com/tinmarino/inmembin/actions/workflows/x86.yml) [![arm Yash on Alpine](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_arm_yash_on_alpine_mode_unit.json)](https://github.com/tinmarino/inmembin/actions/workflows/arm.yml) <br/> [![x86 Yash on Alpine](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_x86_yash_on_alpine_mode_sync.json)](https://github.com/tinmarino/inmembin/actions/workflows/x86.yml) [![x86 Yash on Alpine](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/tinmarino/7b40042f91625feffeaa1941f7aba953/raw/inmembin_x86_yash_on_alpine_mode_async.json)](https://github.com/tinmarino/inmembin/actions/workflows/x86.yml) |
...
| [Shell](#shell)             | lessons learned on posix shell<br/>[command](#command) [compat](#compat) [latin1](#latin1) [main](#main) [hex2dec](#hex2dec) [unhexify](#unhexify) [hexify](#hexify) [endian](#endian) [craft](#craft) |
...
* [__Sh__]: The bourne shell, the first one (1979)
* [__Bash__](https://git.savannah.gnu.org/git/bash.git): default on Linux
  * BASH_VERSION is set
  * Limited to signed 64 bits integer arithmetic
* [__Zsh__](https://github.com/zsh-users/zsh): default on Mac
  * ZSH_VERSION is set
* [__Ash__](https://www.in-ulm.de/~mascheck/various/ash/): The smallest BSD, no more feature than Posix
  * Do not support `printf "\x41"`
* [__Ksh__](https://en.wikipedia.org/wiki/KornShell#Variants): Powerful for 1990 (pre 64 bits era)
  * [mksh](https://github.com/MirBSD/mksh) or [ksh93](https://github.com/ksh93/ksh)
  * KSH_VERSION is set
...
* [__Yash__](https://github.com/magicant/yash): Japanese => made for unicode
  * Supports unicode which is bad for us: at beginning, cannot expand char large than 0x7f, See [input.c::read_input](https://github.com/magicant/yash/blob/67056d1dac9cbfadb75e4dfb79c614fd12d93a2a/input.c#L158-L160) using [std::mbrtowc](https://en.cppreference.com/w/cpp/string/multibyte/mbrtowc)

### latin1 <a name="latin1"></a>
